...
for problem in selected_problems:
  optimal_score, optimal_permutation = get_optimum('../QapData/' + problem + '.sln')

  alg_results = {}
  for alg in algs.keys():
      alg_results[alg] = {}
      alg_score, alg_permutation = get_results('../QapSolver/results/' + problem + '_' + alg + '_' + str(size) + '.sln')
      alg_results[alg]['quality'] = quality(alg_score, optimal_score)
      alg_results[alg]['similarity'] = similarity_percentage(alg_permutation, optimal_permutation)
